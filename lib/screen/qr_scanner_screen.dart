...
class QrScannerScanScreen extends StatefulWidget {
  const QrScannerScanScreen({super.key});

  @override
  State<QrScannerScanScreen> createState() => _QrScannerScanScreenState();
}

class _QrScannerScanScreenState extends State<QrScannerScanScreen> {
