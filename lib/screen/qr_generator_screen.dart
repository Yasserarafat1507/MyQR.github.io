...
class _QrGeneratorScreenState extends State<QrGeneratorScreen> {
  ...
  String? qrRawValue; // raw value of the qr code
  Color qrColor = Colors.white; // color of the qr code
  final List<String> qrTypes = ['JPG', 'PNG', 'SVG', 'PDF']; // types of qr code
  String? selectedQrType; // select qr type
